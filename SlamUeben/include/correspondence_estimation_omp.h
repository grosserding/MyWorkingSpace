...
class CorrespondenceEstimationOMP
    : public CorrespondenceEstimation<PointSource, PointTarget, Scalar> {
 public:
  /** \brief Empty constructor. */
  CorrespondenceEstimationOMP() { corr_name_ = "CorrespondenceEstimationOMP"; }
  ...
  clone() const {
    Ptr copy(new CorrespondenceEstimationOMP<PointSource, PointTarget, Scalar>(
        *this));
    return (copy);
  }
};
